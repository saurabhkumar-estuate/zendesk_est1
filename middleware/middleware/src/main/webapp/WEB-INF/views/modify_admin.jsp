...
<header class="text-left">
	...
	<main role="main" class="container col-8 pl-0 pr-0">
		<nav class="nav nav-pills nav-justified">
			<a class="nav-item nav-link pt-3 pb-3" id="nav-admin-page2-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-admin-page2" aria-selected="false">Add Connectors</a>
				<a class="nav-item nav-link active pt-3 pb-3"  id="nav-admin-page1-tab" data-toggle="tab" href="#nav-home"  role="tab" aria-controls="nav-admin-page1" aria-selected="true">Modify Connectors</a> 		
		  </nav> 
